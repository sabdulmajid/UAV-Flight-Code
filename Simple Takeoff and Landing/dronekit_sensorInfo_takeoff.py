...
"""
All different types of sensors:
...
while vehicle.location.global_relative_frame.alt < target_altitude * 0.95:
    try:
        ...
        full_capacity_voltage = 12.6  # Adjust this value according to your battery specifications
        empty_capacity_voltage = 10.6  # Adjust this value according to your battery specifications
