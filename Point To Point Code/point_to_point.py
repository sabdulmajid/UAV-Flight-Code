...
print("Going towards the first point for 30 seconds...")
point1 = LocationGlobalRelative(-35.361354, 149.165218, 20)
vehicle.simple_goto(point1)

# Sleep so we can see the change in the map
time.sleep(30)

print("Going towards the second point for 30 seconds (groundspeed set to 10 m/s)...")
